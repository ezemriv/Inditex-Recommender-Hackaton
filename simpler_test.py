...
# data_folder = os.path.join(parent_folder, "data/processed")
# train = pl.read_parquet(f"{data_folder}/train.parquet")
# # filtered_train = train.filter((pl.col("user_id") == 179371) | (pl.col("user_id") == 8287))
# filtered_train = train.filter(pl.col("user_id").is_in([179371, 8287, 388076, 156824, 247419, 211084, 211101]))
# sample_data = filtered_train.to_pandas()
